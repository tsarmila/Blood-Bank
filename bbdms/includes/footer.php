          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span class="text-white">Blood Bank</span>
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>We envision a world where no one loses a loved one due to the unavailability of blood. By harnessing the power of technology and community, we aim to build a sustainable and reliable blood donation ecosystem.</p>
          </div>
