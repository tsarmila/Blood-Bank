        ...
        <div class="main-top py-1" style="padding: 5px 0;">
            <nav class="navbar navbar-expand-lg navbar-light fixed-navi" style="min-height: 50px; padding: 5px 10px;>
                <div class="container">
                    <!-- logo -->
                    <h1>
                       <a href="index.php"> <img src="images/logo.png" alt="" style="max-height: 80px; width: auto;"></a>
                    ...
                    <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="search-donor.php" style="color: Black;">Search Donor</a>
                            </li>
