				...
				<li>
					<div class="banner-top1">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>Your Blood, Their Hope:
									<br><span>Why Every Drop Counts</span>
								</h3>
								<div class="button">
				<a href="about.php" class="w3ls-button-agile text-dark">Read More
				...
				<li>
					<div class="banner-top3">
						<div class="banner col-lg-12">
							<div class="d-flex container py-xl-1 py-lg-1">
	...
	<div class="blog-w3ls py-5" id="blog">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title text-black">Some of the Donar</h3>
				<span>
...
{ ?>
				<div class="col-md-4 pricing" style="margin-top:2%;">
					...
					<div class="price-top">
							...
							<img src="images/preview.jpg" alt="" class="img-fluid" />
	...
	<div class="screen-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Blood Type Compatibility</h3>
				<span>
					<i class="fas fa-user-md"></i>
				</span>
				<p class="mt-2">Together, We Can Make a Difference</p>
			</div>
			<div class="row">
            <div class="col-lg-6">
...
<li>AB positive or AB negative.</li>
			...
			<div class="d-flex">
            <div class="col-lg-12">
                <img class="img-fluid rounded" src="images/ban3.png" alt="">
            </div>
			</div>
...
Type O individuals are often called "universal donors" since their blood can be transfused into persons with any blood type. Those with type AB blood are called "universal recipients" because they can receive blood of any type.</p>
			...
			href="login.php"> Become a Donar</a>
