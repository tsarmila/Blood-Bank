	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			...
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">Connect with donors ready to save lives: Explore the list now.</p>
			</div>
			<div class="d-flex">
...
{ ?>
				<div class="col-md-4 pricing">
					...
					<div class="price-top">
							...
							<img src="images/preview.jpg" alt="Blood Donor" style="border:1px #000 solid" class="img-fluid" />
